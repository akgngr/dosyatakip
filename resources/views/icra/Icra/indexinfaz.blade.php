...
@section('header')
    <section class="content-header">
        <h1>
            <span class="text-capitalize">İcra Dosyaları</span>
            <div class="box-header hidden-print pull-right">
                <a href="{{ route('icra.create') }}" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Yeni İcra Dosyası Ekle</span></a>
            </div>
        </h1>
    </section>
@endsection
<div class="box">
    ...
    <table id="icra" class="table table-responsive  table-bordered table-hover">
        <thead>
            <tr>
...
$(document).ready(function(){
                ...
                $('#icra thead tr').clone(true).appendTo( '#icra thead' );
                $('#icra thead tr:eq(1) th').each( function (i) {
                    var title = $(this).text();
            ...
            var table = $('#icra').DataTable({
            orderCellsTop: true,
            processing: true,
            serverSide: true,
            ajax: 'http://127.0.0.1:8000/admin/icra/icra/derdest',
